...
<div class="main">
  <div class="topnav">
     ...
     <div class="nav2">
            ...
            <div class="headtop">
            <a class="productbig" href="product.php?id=19"> <img  src="images/mensection.png" alt="imagesmid" style="width:60%; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.4);"></a>
            </div>
            <br>
            <br>
<div class="container">
...
<?php
  ...
  $querymen = "SELECT * FROM webiste.product WHERE product_category = 'Men'";
  if (!empty($brand)) {
      $querymen .= " AND brand = '$brand'";
  }
  if (!empty($price)) {
      $querymen .= " AND product_price <= '$price'";
  }
